...
/**
 * Clase que representa las cuentas de usuario en el sistema del cajero.
 */
 ...
 * @param Ap           El primer apellido del titular de la cuenta.
 * @param Am           El segundo apellido del titular de la cuenta.
 * @param ci           El número de identificación del titular de la cuenta.
 * @param dia          El día de nacimiento del titular de la cuenta.
 * @param mes          El mes de nacimiento del titular de la cuenta.
 * @param anio         El año de nacimiento del titular de la cuenta.
...
/**
 * Crea una nueva cuenta con la información proporcionada, incluyendo
 * datos adicionales del usuario y el PIN.
 * 
 * @param nombre       El nombre del titular de la cuenta.
 * @param Ap           El primer apellido del titular de la cuenta.
 * @param Am           El segundo apellido del titular de la cuenta.
 ...
 * @param pin          El PIN de seguridad de la cuenta.
 */
...
/**
 * Crea una nueva instancia de Cuentas y lee el archivo "usuario.txt".
 */
    public Cuentas() {
        lineas = leerArchivo("usuario.txt");
    }
...
/**
 * Lee el archivo de cuentas y verifica si existe una cuenta con un cierto CI y tipo de cuenta.
 * Si el archivo no existe, se crea uno nuevo.
 * 
 * @return {@code true} si se encuentra una cuenta con el CI y tipo de cuenta especificados, {@code false} en caso contrario.
 */
...
/**
 * Comprueba si el CI y el tipo de cuenta proporcionados coinciden con los valores de la instancia actual.
 * 
 * @param ci El código de identificación a verificar.
 * @param tipoCuenta El tipo de cuenta a verificar.
 * @return {@code true} si el CI y el tipo de cuenta coinciden con los valores de la instancia, {@code false} en caso contrario.
 */
    public boolean comprobarCiYTipoCuenta(int ci, String tipoCuenta) {
        return this.ci == ci && this.tipoCuenta.equals(tipoCuenta);
    }
/**
 * Indica si la cuenta ya existe.
 * 
 * @return {@code true} siempre, indicando que la cuenta existe. Este método puede ser modificado para una verificación más precisa.
 */
    public boolean cuentaExistente() {
        return true;
    }
/**
 * Comprueba si el usuario y el PIN proporcionados existen en las líneas de usuarios leídas del archivo.
 * 
 * @param usuario El nombre de usuario a verificar.
 * @param pin El PIN asociado al usuario a verificar.
 * @return {@code true} si el usuario y el PIN existen y coinciden con los datos almacenados, {@code false} en caso contrario.
 */
